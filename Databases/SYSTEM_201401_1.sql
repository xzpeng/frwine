...
# Type: 系统自动备份
# Description:当前SQL文件包含了表：frw_access、frw_admin、frw_category、frw_member、frw_news、frw_node、frw_role、frw_role_user的结构信息，表：frw_access、frw_admin、frw_category、frw_member、frw_news、frw_node、frw_role、frw_role_user的数据
# Time: 2014-01-02 16:08:30
# -----------------------------------------------------------
# 当前SQL卷标：#1
# -----------------------------------------------------------
...
# 数据库表：frw_admin 数据信息
INSERT INTO `frw_admin` VALUES ('1','超级管理员','pengxiaozhou2008@gmail.com','59089b68a77dbc954acb874104c35980','1','我是超级管理员 哈哈~~','','1388649886');
